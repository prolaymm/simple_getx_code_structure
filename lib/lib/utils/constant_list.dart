...
List<CategoryButtonVo> zItemCategoryList = [
   CategoryButtonVo(icon: "assets/icons/phone.svg", title: "Phone", onClick: ()=> debugPrint("Hello World")),
   CategoryButtonVo(icon: "assets/icons/tablet.svg", title: "Tablet", onClick: ()=> debugPrint("Hello World")),
   CategoryButtonVo(icon: "assets/icons/laptop.svg", title: "Laptop", onClick: ()=> debugPrint("Hello World")),
   CategoryButtonVo(icon: "assets/icons/tv.svg", title: "TV", onClick: ()=> debugPrint("Hello World")),
